...
var __PRIVATE_MemoryDocumentOverlayCache = class {
  constructor() {
    this.overlays = new SortedMap(DocumentKey2.comparator), this.dr = /* @__PURE__ */ new Map();
  }
  getOverlay(e, t) {
          ...
          function __PRIVATE_handleTargetError(e2, t2) {
            return __async(this, null, function* () {
              ...
              for (const r of t2.targetIds)
                e2.L_.has(r) && (yield e2.remoteSyncer.rejectListen(r, n2), e2.L_.delete(r), e2.U_.removeTarget(r));
            });
          }(e, t)
        );
      } catch (n2) {
        ...
        */
        function __PRIVATE_raiseWatchSnapshot(e2, t3) {
          ...
          n2.targetMismatches.forEach((t4, n3) => {
            ...
            if (!r)
              return;
            e2.L_.set(t4, r.withResumeToken(ByteString2.EMPTY_BYTE_STRING, r.snapshotVersion)), // Cause a hard reset by unwatching and rewatching immediately, but
...
var __PRIVATE_SyncEngineImpl = class {
  constructor(e, t, n, r, i, s) {
     ...
     * active target.
     */
    this.Ba = new SortedMap(DocumentKey2.comparator), /**
...
var Firestore2 = class extends Firestore$1 {
  /** @hideconstructor */
  constructor(e, t, n, r) {
    super(e, t, n, r), /**
...
function onSnapshot2(e, ...t) {
  ...
  let a, u, c;
  if (e instanceof DocumentReference2) u = __PRIVATE_cast2(e.firestore, Firestore2), c = __PRIVATE_newQueryForPath(e._key.path), a = {
    next: (n2) => {
    ...
    u = __PRIVATE_cast2(n2.firestore, Firestore2), c = n2._query;
...
function getAggregateFromServer2(e, t) {
  const n = __PRIVATE_cast2(e.firestore, Firestore2), r = ensureFirestoreConfigured2(n), i = __PRIVATE_mapToArray(t, (e2, t2) => new __PRIVATE_AggregateImpl(t2, e2.aggregateType, e2._internalFieldPath));
...
!function __PRIVATE_registerFirestore(e, t = true) {
  !function __PRIVATE_setSDKVersion(e2) {
    ...
    const i = e2.getProvider("app").getImmediate(), s = new Firestore2(new __PRIVATE_FirebaseAuthCredentialsProvider(e2.getProvider("auth-internal")), new __PRIVATE_FirebaseAppCheckTokenProvider(e2.getProvider("app-check-internal")), function __PRIVATE_databaseIdFromApp(e3, t2) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion2(w, "4.7.6", e), // BUILD_TARGET will be replaced by values like esm2017, cjs2017, etc during the compilation
  registerVersion2(w, "4.7.6", "esm2017");
}();
...
// node_modules/@angular/fire/node_modules/firebase/firestore/dist/esm/index.esm.js
...
__export2(angular_fire_firestore_exports, {
  ...
  fromRef: () => fromRef2,
  getAggregateFromServer: () => getAggregateFromServer3,
  getCountFromServer: () => getCountFromServer3,
  getDoc: () => getDoc2,
...
__reExport(angular_fire_firestore_exports, public_api_exports);
export {
  Firestore3 as Firestore,
  FirestoreInstances,
  FirestoreModule,
  addDoc2 as addDoc,
