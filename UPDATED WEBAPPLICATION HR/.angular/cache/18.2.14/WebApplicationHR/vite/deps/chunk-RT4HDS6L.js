...
var angular_fire_app_check_exports = {};
__export2(angular_fire_app_check_exports, {
  AppCheck: () => AppCheck,
  AppCheckInstances: () => ɵAppCheckInstances,
  AppCheckModule: () => AppCheckModule,
  appCheckInstance$: () => appCheckInstance$,
  getLimitedUseToken: () => getLimitedUseToken2,
  getToken: () => getToken2,
  initializeAppCheck: () => initializeAppCheck2,
  onTokenChanged: () => onTokenChanged2,
  provideAppCheck: () => provideAppCheck,
  setTokenAutoRefreshEnabled: () => setTokenAutoRefreshEnabled2
});
...
var AppCheckModule = class _AppCheckModule {
  ...
  static ɵfac = function _AppCheckModule_Factory(__ngFactoryType__) {
...
__reExport(angular_fire_app_check_exports, public_api_exports);
...
var AngularFireModule = class _AngularFireModule {
  ...
  static ɵfac = function _AngularFireModule_Factory(__ngFactoryType__) {
...
function ɵcacheInstance(cacheKey, moduleName, appName, fn, deps) {
  ...
  if (instance) {
    if (!matchDep(deps, cachedDeps)) {
      log2("error", `${moduleName} was already initialized on the ${appName} Firebase App with different settings.${IS_HMR ? " You may need to reload as Firebase is not HMR aware." : ""}`);
      log2("warn", {
        is: deps,
        was: cachedDeps
      });
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name3, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-4T5ACFAO.js"))), map(() => ɵfirebaseAppFactory(options, zone, name3)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
    ...
    return ɵlazySDKProxy(this, auth, zone, {
      spy: {
        apply: (name22, _, val) => {
          if (name22.startsWith("signIn") || name22.startsWith("createUser")) {
  ...
  static ɵfac = function _AngularFireAuth_Factory(__ngFactoryType__) {
...
var AngularFireAuthModule = class _AngularFireAuthModule {
  ...
  static ɵfac = function _AngularFireAuthModule_Factory(__ngFactoryType__) {
...
firebase/compat/app/dist/esm/index.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-RT4HDS6L.js.map
