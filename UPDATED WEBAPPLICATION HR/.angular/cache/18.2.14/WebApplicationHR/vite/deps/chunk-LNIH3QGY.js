...
import {
  ...
  ɵzoneWrap
} from "./chunk-W3GCO32Y.js";
import {
  openDB,
  registerVersion
} from "./chunk-SGDTGN2P.js";
import {
  InjectionToken,
  Injector,
  NgModule,
  ...
  static create(auth, persistenceHierarchy, userKey = "authUser") {
    return __async(this, null, function* () {
      if (!persistenceHierarchy.length) {
        return new _PersistenceUserManager(_getInstance(inMemoryPersistence2), auth, userKey);
      }
      ...
      let selectedPersistence = availablePersistences[0] || _getInstance(inMemoryPersistence2);
...
// node_modules/@angular/fire/node_modules/firebase/auth/dist/esm/index.esm.js
...
__export2(angular_fire_auth_exports, {
  ...
  applyActionCode: () => applyActionCode3,
  authInstance$: () => authInstance$,
  authState: () => authState2,
  beforeAuthStateChanged: () => beforeAuthStateChanged3,
  checkActionCode: () => checkActionCode3,
  confirmPasswordReset: () => confirmPasswordReset3,
  connectAuthEmulator: () => connectAuthEmulator3,
  createUserWithEmailAndPassword: () => createUserWithEmailAndPassword3,
  deleteUser: () => deleteUser3,
  fetchSignInMethodsForEmail: () => fetchSignInMethodsForEmail3,
  getAdditionalUserInfo: () => getAdditionalUserInfo3,
  getAuth: () => getAuth3,
  getIdToken: () => getIdToken3,
  getIdTokenResult: () => getIdTokenResult3,
  getMultiFactorResolver: () => getMultiFactorResolver3,
  getRedirectResult: () => getRedirectResult3,
  idToken: () => idToken2,
  initializeAuth: () => initializeAuth3,
  initializeRecaptchaConfig: () => initializeRecaptchaConfig3,
  isSignInWithEmailLink: () => isSignInWithEmailLink3,
  linkWithCredential: () => linkWithCredential3,
  linkWithPhoneNumber: () => linkWithPhoneNumber3,
  linkWithPopup: () => linkWithPopup3,
  linkWithRedirect: () => linkWithRedirect3,
  multiFactor: () => multiFactor3,
  onAuthStateChanged: () => onAuthStateChanged3,
  onIdTokenChanged: () => onIdTokenChanged3,
  parseActionCodeURL: () => parseActionCodeURL3,
  provideAuth: () => provideAuth,
  reauthenticateWithCredential: () => reauthenticateWithCredential3,
  reauthenticateWithPhoneNumber: () => reauthenticateWithPhoneNumber3,
  reauthenticateWithPopup: () => reauthenticateWithPopup3,
  reauthenticateWithRedirect: () => reauthenticateWithRedirect3,
  reload: () => reload3,
  revokeAccessToken: () => revokeAccessToken3,
  sendEmailVerification: () => sendEmailVerification3,
  sendPasswordResetEmail: () => sendPasswordResetEmail3,
  sendSignInLinkToEmail: () => sendSignInLinkToEmail3,
  setPersistence: () => setPersistence3,
  signInAnonymously: () => signInAnonymously3,
  signInWithCredential: () => signInWithCredential3,
  signInWithCustomToken: () => signInWithCustomToken3,
  signInWithEmailAndPassword: () => signInWithEmailAndPassword3,
  signInWithEmailLink: () => signInWithEmailLink3,
  signInWithPhoneNumber: () => signInWithPhoneNumber3,
  signInWithPopup: () => signInWithPopup3,
  signInWithRedirect: () => signInWithRedirect3,
  signOut: () => signOut3,
  unlink: () => unlink3,
  updateCurrentUser: () => updateCurrentUser3,
  updateEmail: () => updateEmail3,
  updatePassword: () => updatePassword3,
  updatePhoneNumber: () => updatePhoneNumber3,
  updateProfile: () => updateProfile3,
  useDeviceLanguage: () => useDeviceLanguage3,
  user: () => user2,
  validatePassword: () => validatePassword3,
  verifyBeforeUpdateEmail: () => verifyBeforeUpdateEmail3,
  verifyPasswordResetCode: () => verifyPasswordResetCode3
});
...
rxfire/auth/index.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LNIH3QGY.js.map
